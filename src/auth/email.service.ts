...
export class EmailService {
  ...
  async sendVerificationEmail(email: string, token: string): Promise<void> {
    ...
    const mailOptions = {
      from: {
        name: 'Trung tâm chăm sóc da',
        address: this.configService.get('EMAIL_USERNAME'),
      },
      to: email,
      subject: '🌟 Xác Thực Email - Trung tâm chăm sóc da',
  ...
  async sendWelcomeEmail(email: string, fullName: string): Promise<void> {
    const mailOptions = {
      ...
      to: email,
      subject: '🎉 Chào mừng đến với Trung tâm chăm sóc da!',
      html: this.createWelcomeEmailTemplate(fullName),
      text: `Chào mừng ${fullName} đến với Trung tâm chăm sóc da!`,
    };
  ...
  async sendForgotPasswordEmail(email: string, token: string): Promise<void> {
    ...
    const mailOptions = {
      ...
      to: email,
      subject: '🔑 Đặt lại mật khẩu - Trung tâm chăm sóc da',
  ...
  async sendForgotPasswordOtpEmail(email: string, otp: string): Promise<void> {
    const mailOptions = {
      ...
      to: email,
      subject: '🔑 Mã xác thực đặt lại mật khẩu (OTP) - Trung tâm chăm sóc da',
    ...
    <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f5f5f5;">
        ...
        <div style="background: white; padding: 50px 40px; border-radius: 0 0 15px 15px; box-shadow: 0 8px 25px rgba(0,0,0,0.1);">
            ...
            <div style="text-align: center; margin-bottom: 30px;">
                <p style="font-size: 18px; margin-bottom: 15px; color: #2C3E50;">Chào mừng bạn đến với <strong style="color: #27AE60;">Trung tâm chăm sóc da</strong>! 🎉</p>
            ...
            <p style="text-align: center; color: #7F8C8D; font-style: italic; font-size: 16px; margin-top: 30px;">
                Cảm ơn bạn đã tin tưởng Trung tâm chăm sóc da! 💚
            </p>
        </div>
        
        <!-- Footer -->
        <div style="text-align: center; padding: 30px 20px; color: #95A5A6; font-size: 14px; background: #ECF0F1; border-radius: 0 0 15px 15px;">
            <p style="margin: 0 0 8px 0;"><strong style="color: #27AE60;">Trung tâm chăm sóc da</strong> - Giải pháp chăm sóc da toàn diện</p>
            <p style="margin: 0; font-size: 12px;">© 2025 Trung tâm chăm sóc da. All rights reserved.</p>
        ...
        <div style="background: white; padding: 50px 40px; border-radius: 0 0 15px 15px; box-shadow: 0 8px 25px rgba(0,0,0,0.1);">
            ...
            <div style="text-align: center; margin-bottom: 40px;">
                <p style="font-size: 18px; margin-bottom: 15px; color: #2C3E50;">
                    Cảm ơn bạn đã tham gia cộng đồng <strong style="color: #27AE60;">Trung tâm chăm sóc da</strong>! 💚
                </p>
